...
export const apartmentApi = async (result: IRegionItem): Promise<IApartment> => {
  ...
  const apartmentUrl = `https://apis.data.go.kr/1613000/RTMSDataSvcAptTrade/getRTMSDataSvcAptTrade?serviceKey=${API_KEY}&LAWD_CD=${result.region_cd}&DEAL_YMD=${currentDate}&pageNo=1&numOfRows=50`;
