...
// import type { IGeocodeData, IFirestore, ILocationData } from "@/src/commons/types";
...
// export const useAllMarker = ({ data, firestoreDatas, setSelectedMarkerData, setVisibleMarkerDatas }: IUseAllMarkerProps): void => {
