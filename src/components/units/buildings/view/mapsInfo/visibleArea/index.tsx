...
export default function VisibleArea({ visibleMarkerDatas, matchingDatas, selectedData, setSelectedData, buildingType }: IVisibleAreaProps): JSX.Element {
      ...
      {matchingMarkerData.length !== 0 ? (
        <>
          ...
          {selectedData !== undefined ? (
            ...
            <BuildingInfo matchingDatas={matchingDatas} selectedData={selectedData} buildingType={buildingType} setSelectedData={setSelectedData} />
          ) : (
