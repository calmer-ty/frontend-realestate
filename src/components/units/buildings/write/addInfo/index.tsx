...
export default function AddInfo(props: IAddInfoProps): JSX.Element {
  const { register, control, editData } = props;
    ...
    <section>
      ...
      <div className="inputUnit">
        <BasicTextField
          ...
          defaultValue={editData.isEdit ? editData.docData?.floor : ""}
      ...
      <ControlRadio label="엘리베이터" selectLabel1={"없음"} selectLabel2={"있음"} name="elevator" control={control} isEdit={editData.isEdit} hasValue={editData.docData?.elevator} />
    </section>
  );
}
