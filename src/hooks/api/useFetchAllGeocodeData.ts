...
import type { IGeocodeData, IGeocodeDataParams } from "@/src/commons/types";
...
export const useFetchAllGeocodeData = ({ regionCode, buildingType }: IGeocodeDataParams): IUseFetchAllGeocodeDataReturn => {
