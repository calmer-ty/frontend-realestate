...
// export default async function fetchApartment(req: NextApiRequest, res: NextApiResponse): Promise<void> {
...
//   try {
//     const data = await getApartmentData(regionCode); // 지역 데이터 처리 함수를 호출하고 결과를 기다립니다
